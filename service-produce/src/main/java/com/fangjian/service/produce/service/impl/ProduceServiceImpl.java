package com.fangjian.service.produce.service.impl;
...
import com.fangjian.service.produce.model.Produce;
import com.fangjian.service.produce.service.ProduceService;
...
public class ProduceServiceImpl implements ProduceService {
    ...
    public void updateStore(int produceId, int store, String key) throws Exception {
        ...
        log.info("本地事务或者逻辑如果出错，因为A服务已经完成，则需要把B系统错误的地方记录下来，人工干预，最终一致性");
