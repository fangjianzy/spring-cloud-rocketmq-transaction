package com.fangjian.service.order.controller;
...
import com.fangjian.service.order.mqservice.TransactionProducer;
...
public class OrderController {
    ...
    public Object save(int userId, int productId, int total) throws MQClientException {
        ...
        System.out.printf("用户userId=%s,选择商品 productId=%s，下订单数=%s \n", userId, productId,total);
        System.out.println("封装信息到mq...........");
        //封装消息实体
